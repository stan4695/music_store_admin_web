	...
	<body>
		<%
        	...
        	if (s != null) {
	        	jb.connect();
	        	int idclient;
	 			ResultSet rs1 = jb.vedeTabela("tblAlbume");
	            int aux = java.lang.Integer.parseInt(s);
	            ResultSet rs = jb.intoarceLinieDupaId("tblProduseComenzi", "id", aux);
	            rs.first();
	            String id_comanda = rs.getString("id_comanda");
		        ...
		        <main>
		            <div class="form-section container-fluid d-flex flex-column flex-wrap align-items-center justify-content-center">
		                ...
		                <div id="form-section" class="form">
		                    <form action="updateProdus.jsp" method="post" class="needs-validation" novalidate>
		                        <h5 class="form-incentive">Introdu datele în câmpurile de mai jos.</h5>		                 
		                      	...
		                      	<div class="mb-3">
		                            ...
		                            <input type="text" class="form-control" name="id_comanda" id="idInput" aria-describedby="idHelp" placeholder="ID Code" value="<%= id_comanda%>" readonly>
		                        ...
		                        <div class="mb-3">
		                            ...
		                            <select id="id_produs" name="id_produs" class="form-select" required>
								       <%
                                    while(rs1.next()){
                                        int idProdus = rs1.getInt("id");
                                        String numeAlbum = rs1.getString("nume_album");
                                        String artist = rs1.getString("artist");
                                        String genMuzical = rs1.getString("gen_muzical");
                                        String casaDiscuri = rs1.getString("casa_discuri");
                                     	String tipProdus = rs1.getString("tip_produs");
                                %>
		                        ...
		                        <div class="mb-3">
		                            ...
		                            <input type="number" class="form-control" name="cantitate" id="cantityInput" placeholder="Introdu cantitatea produsului" value="<%= cantitate%>">
		                        </div>
